          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: _SectionLabel('MENU MASTER'),
              ),
                ...
                child: GridView.count(
                  ...
                  children: [
                    _GradientCard(
                      ...
                      subtitle: 'Kelola akun & hak akses user',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const WebViewScreen(
                              title: 'User Management',
                              url: 'https://office.mykfin.com/users?mobile_app=1',
                            ),
                          ),
                        );
                      },
                    ...
                    _GradientCard(
                      ...
                      title: 'Master Divisi',
                      subtitle: 'Kelola data divisi perusahaan',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const WebViewScreen(
                              title: 'Master Divisi',
                              url: 'https://office.mykfin.com/divisions?mobile_app=1',
                            ),
                          ),
                        );
                      },
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => const WebViewScreen(
                              title: 'Konfigurasi Penandatanganan',
                              url: 'https://office.mykfin.com/documents/signers?mobile_app=1',
                            ),
                          ),
                        );
                      },
                    ...
                    _GradientCard(
                      ...
                      subtitle: 'Stempel resmi perusahaan',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const WebViewScreen(
                              title: 'Konfigurasi Stempel',
                              url: 'https://office.mykfin.com/documents/stamp?mobile_app=1',
                            ),
                          ),
                        );
                      },
...
/// ==== KARTU MENU: grid card gradient, mengikuti gaya _GradientCard di asset_management_screen.dart ====
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  'Pengaturan master data sistem di sini.',
                  style: TextStyle(
